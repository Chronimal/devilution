...
// ref: 0x1000A4B9
int __fastcall SelConn_1000A4B9(DWORD* a1)
{
    return 0;
}
/* {
...
// ref: 0x1000A4CD
int UNKCALL SelConn_1000A4CD(void* arg)
{
    return 0;
}
/* {
...
// ref: 0x1000A9F3
int UNKCALL SelConn_1000A9F3(HWND hWnd)
{
    return 0;
}
/* {
...
// ref: 0x1000AC9E
int UNKCALL SelConn_1000AC9E(HWND hWnd)
{
    return 0;
}
/* {
...
// ref: 0x1000ADA8
int UNKCALL SelConn_1000ADA8(HWND hWnd)
{
    return 0;
}
/* {
...
// ref: 0x1000AE59
HWND __fastcall SelConn_1000AE59(HWND hWnd, int a2, int a3)
{
    return 0;
}
/* {
