...
// BOOL __stdcall UiProfileCallback(int a1, int a2, int a3, int a4, LPARAM a5, int a6, int a7, int a8, int (__stdcall
// *a9)(DWORD, DWORD, DWORD, DWORD));
...
BOOL __fastcall SelHero_NameHasChar(const char* name, const char* illegalchrs);
...
BOOL __stdcall UiSelHeroMultDialog(
    ...
    BOOL(__stdcall* fnstats)(int, _uidefaultstats*),
    int* dlgresult,
    int* a6,
    char* name);
