...
#define smk_huff8_build(bs, t)                                                                                         \
    {                                                                                                                  \
        ...
        {                                                                                                              \
            fprintf(                                                                                                   \
                stderr, "libsmacker::smk_huff8_build(" #bs ", " #t ") - ERROR (file: %s, line: %lu)\n", __FILE__,      \
...
#define smk_huff8_lookup(bs, t, s)                                                                                     \
    {                                                                                                                  \
        ...
        {                                                                                                              \
            fprintf(                                                                                                   \
                stderr, "libsmacker::smk_huff8_lookup(" #bs ", " #t ", " #s ") - ERROR (file: %s, line: %lu)\n",       \
...
#define smk_huff16_build(bs, t)                                                                                        \
    {                                                                                                                  \
        ...
        {                                                                                                              \
            fprintf(                                                                                                   \
                stderr, "libsmacker::smk_huff16_build(" #bs ", " #t ") - ERROR (file: %s, line: %lu)\n", __FILE__,     \
                (unsigned long)__LINE__);                                                                              \
            goto error;                                                                                                \
        }                                                                                                              \
    }
...
#define smk_huff16_lookup(bs, t, s)                                                                                    \
    {                                                                                                                  \
        ...
        {                                                                                                              \
            fprintf(                                                                                                   \
                stderr, "libsmacker::smk_huff16_lookup(" #bs ", " #t ", " #s ") - ERROR (file: %s, line: %lu)\n",      \
                __FILE__, (unsigned long)__LINE__);                                                                    \
            goto error;                                                                                                \
        }                                                                                                              \
    }
